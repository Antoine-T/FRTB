	...
	IRiskSubKey<GIRRVegaBucketKey>
{
	...
	public GIRRVegaRiskFactorKey(RiskFactory _factory,IRccy _currency,Option_Maturity _optionmaturity,IRTenor _irtenor) 
    {
	...
	public String GetString() {
		return girrvegabucketkey.GetString() + "_" + this.optionmaturity.toString() + "_" + this.irtenor.toString();
	}
