...
public class GIRRDeltaRiskFactor  
	extends LinearRiskFactor 
	implements  IRisk<GIRRDeltaRiskFactor, GIRRDeltaRiskFactorKey>
{
	...
	public Double GetCorrelation(GIRRDeltaRiskFactor other) {
		...
		return calculator.GetDeltaCorrelation(this.key.irtenor, other.key.irtenor,this.key.ircurvetype,other.key.ircurvetype);
	}
	...
	public double GetWeight() {
		return calculator.GetDeltaWeight(this.key.irtenor,this.key.girrdeltabucketkey.currency);
