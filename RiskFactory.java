...
import XMLReader.XmlreaderEQUITY;
...
public final class RiskFactory {
	...
	private boolean buildEquityCalculator(){
		...
		XmlreaderEQUITY xmlreader=new XmlreaderEQUITY(); 
		
		equitycalculator = new EquityCalculator(xmlreader.EQUITYx(),
				
				xmlreader.gamma(), 
				xmlreader.EQUITY_Small_lh(), 
				xmlreader.EQUITY_Large_lh(),
				xmlreader.rw(),
				xmlreader.alpha(),
				xmlreader.EQUITYweights(),
				xmlreader.EQUITYRHO());
...
//		Création de la clef pour un axe EquityDelta et ajout dans le dictionnaire global
...
//		Création de la clef pour un axe EquityVega et ajout dans le dictionnaire global
...
//		Création de la clef pour un axe EquityCurvature et ajout dans le dictionnaire global
